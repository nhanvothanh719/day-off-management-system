...
const GroupDetail = () => {
  ...
  const addNewMember = () => {
    if (
      groupStaffs.some(staff => staff._id === selectedMemberId) ||
      groupMasters.some(master => master._id === selectedMemberId)
    ) {
      messageApi.open({
        type: "error",
      ...
      setGroupStaffs([
        ...groupStaffs,
        { _id: selectedMemberId, name: findNameById(selectedMemberId) },
      ]);
    }
    setOpenModal(false);
  };
    ...
    >
      ...
      <Space direction="vertical" size={20} style={{ width: "100%" }}>
        ...
        <Space className="update-btn__area">
          <Button className="update-group__button" onClick={updateGroup}>
            Update
          </Button>
        </Space>
      </Space>
