...
const DayOffTable = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: () => {
        return (
          <>
            <Row className="dayoff-detail__actions">
              <Col className="dayoff-detail__icon" onClick={showModalApprove}>
                <CheckSquareFilled />
              </Col>
              <Col className="dayoff-detail__icon2" onClick={showModalReject}>
                <CloseSquareFilled />
              </Col>
              <Col className="dayoff-detail__icon3" onClick={handleOnClick}>
                <EditFilled />
              </Col>
            </Row>
          </>
  ...
  const start = () => {
    setLoading(true);
    // ajax dayoff after empty completing
    setTimeout(() => {
      setSelectedRowKeys([]);
      setLoading(false);
    }, 1000);
